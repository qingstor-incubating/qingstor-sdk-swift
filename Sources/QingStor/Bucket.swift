...
public class GetBucketNotificationOutput: QingStorOutput {
    ...
    @objc public var notifications: [NotificationsModel]? = nil
...
public class PutBucketNotificationInput: QingStorInput {
    /// Bucket Notifications
    @objc public var notifications: [NotificationsModel]! // Required
    ...
    @objc public init(notifications: [NotificationsModel]) {
        super.init()
