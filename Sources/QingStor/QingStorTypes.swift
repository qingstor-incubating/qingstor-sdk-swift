...
public class NotificationModel: BaseModel {
    ...
    /// Initialize `NotificationModel` with the specified `map`.
    public required init?(map: Map) {
        super.init(map: map)
    }

    /// Initialize `NotificationModel` with the specified parameters.
    ...
    @objc public override func validate() -> Error? {
        if self.cloudfunc == nil {
            return APIError.parameterRequiredError(name: "cloudfunc", parentName: "Notification")
        }
        
        if let cloudfunc = self.cloudfunc {
            let cloudfuncValidValues: [String] = ["tupu-porn", "notifier", "image"]
        ...
        if self.eventTypes == nil {
            return APIError.parameterRequiredError(name: "eventTypes", parentName: "Notification")
        }
        ...
        if self.id == nil {
            return APIError.parameterRequiredError(name: "id", parentName: "Notification")
        }
